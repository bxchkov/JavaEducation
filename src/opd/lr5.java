...
public class lr5 {
    public static void main(String[] args) {
        ...
        System.out.printf("Среднеквадратичное отклонение суммарной трудоемкости кодирования проекта равно %.2f чел×час\n", tCKO);
        double Etotal95 = Etl + 2 * tCKO;
        System.out.printf("Суммарная трудоемкость кодирования проекта с вероятность 95 процентов равна %.2f чел×час\n", Etotal95);
        double relativeCKO = (tCKO / Etl) * 100;
        System.out.printf("Относительная погрешность в оценке суммарной трудоемкости кодирования равна %.2f чел×час\n", relativeCKO);
